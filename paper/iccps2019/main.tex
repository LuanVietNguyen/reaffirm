...
%\usepackage{beramono}
 ...
 \lstset{
 	language=Python,
 	morekeywords={function,for, end, input, output, parameters, each,in,with,is,valid,from,to,property,stop,variable,counterexample,forall,then, begin, algorithm, Initialization, Require, Initialize, increase, length, find,getModelByName,strrep,copyModel,addState, addMode, addParam, getCopyMode, replace,addTransition,getCopyState,getCopyState,addTransition,formode,fortran,sfroot,getTransitions,getStates,notDefaultTransition, addLocalVar, addFlow, addGuardLabel, addResetLabel}, % note otherkeywords vs. morekeywords
...
%\author{Gautam Mohan}
%\affiliation{\institution{Department of Computer and Information Science University of Pennsylvania}} \email{gmohan1@seas.upenn.edu}
