...
%pos_tgt   = [4500+x_ini -h_ini-1000]; % Initial Target position [m]
v_tgt     = 1*328;		% Target Velocity [m/s]
...
%tors  	    = 1;		% Tracking Loop Time Constant [sec]
...
%==================================================================
load aero_guid_autop_copy	        % Gain Scheduled autopilot gains
max_acc = 40*9.81;              % Maximum demanded acceleration %% reduce demanded acceleration
agun = 0; % angular noise
