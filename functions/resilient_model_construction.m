function [resilient_model, modelName, pos] = resilient_model_construction(modelName, mono, newGuards, best_value, tol, count, pos, nLoop, option_resilient_to_nominal)
    ...
    if nLoop > 1 && option_resilient_to_nominal
        ...
        backGuards.label = guard_inferrence((-1)*mono, newGuards, best_value + mono*tol);
